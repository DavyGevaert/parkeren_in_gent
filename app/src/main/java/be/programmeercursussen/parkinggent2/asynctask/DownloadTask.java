package be.programmeercursussen.parkinggent2.asynctask;
...
/**
 * Created by Davy on 27/12/2015.
 */
public class DownloadTask extends AsyncTask<Object, Integer, ArrayList<Parking>> {
    ...
    private ArrayList<Parking> parseResult(String result) {
        ...
        try {
            ...
            for (int i = 0; i < parkings.length(); i++) {
                ...
                be.programmeercursussen.parkinggent2.model.Status st = new be.programmeercursussen.parkinggent2.model.Status();
