package be.programmeercursussen.parkinggent2.model;
...
public class OpeningTimesInfo implements Parcelable {
    ...
    public static final Parcelable.Creator<OpeningTimesInfo> CREATOR =
            new Parcelable.Creator<OpeningTimesInfo>() {
